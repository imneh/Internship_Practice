...
public class MiniOrganisationManagement{
public static void main(String[] args){
Manager manager = new Manager("Neha", 20, 100000, "Development", "IT");
Developer developer = new Developer("Neha", 20, 80000, "Java", 3);
